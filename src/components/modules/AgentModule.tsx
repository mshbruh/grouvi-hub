...
• Сервер — выполняй команды, читай/пиши файлы, смотри статус, управляй Docker
...
5. При работе с сервером будь аккуратен — не удаляй критичные файлы, не останавливай важные сервисы без подтверждения`;
